...
public class KgToPound extends AppCompatActivity {
    ...
    ImageView pound_kg, kg_g, m_feet, temp, m_cm, speed;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pound_kg = findViewById(R.id.pound_kg);
...
//        }
        ...
        pound_kg.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(KgToPound.this, PoundToKg.class);
        ...
        m_cm.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(KgToPound.this, MeterToCm.class);
                startActivity(intent);
            }
        });
        ...
        speed.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(KgToPound.this, Speed.class);
                startActivity(intent);
            }
        });
